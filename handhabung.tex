...
\begin{frame}{Auswahl einer Lizenz}
	\begin{center}
		\begin{tabular}{ccc}
		\visible<2->{\includegraphics[width=1cm]{res/PD-icon.pdf}} & \visible<3->{\includegraphics[width=1cm]{res/by.pdf}} & \visible<4->{\includegraphics[width=1cm]{res/copyleft.pdf}} \\ 
		\visible<2->{Public Domain} & \visible<3->{Permissiv} & \visible<4->{Copyleft} \\
		\visible<2->{\includegraphics[width=2.8cm]{res/cc-zero.pdf}} & \visible<3->{\includegraphics[width=2.8cm]{res/mit-logo.pdf}} & \visible<4->{\includegraphics[width=2.8cm]{res/gpl-v3-logo.pdf}} \\
		\hspace{0.3\textwidth} & \hspace{0.3\textwidth} & \hspace{0.3\textwidth} \\
		\end{tabular} 
	\end{center}
	\begin{itemize}
		\visible<5->{\item \url{http://choosealicense.com/}}
	\end{itemize}
	\vspace{1cm}
\end{frame}
\note
