...
\begin{frame}{Auswahl einer Lizenz}
	\begin{center}
		...
		\visible<3->{\includegraphics[width=2.8cm]{res/cc-zero.pdf}} & \visible<5->{\includegraphics[width=2.8cm]{res/mit-logo.pdf}} & \visible<7->{\includegraphics[width=2.8cm]{res/gpl-v3-logo.pdf}} \\
