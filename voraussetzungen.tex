...
\begin{adjustwidth}{-2.5em}{-2.5em}
	\begin{center}
		...
		[
			...
			centerbox/.style = {box, minimum width=1.75cm, minimum height=1.75cm},
		...
		\visible<8->{
			\node[above = 2.5cm of center] (floss) {FLOSS: Free/Libre Open Source Software};
		}

		\visible<2->{
			\node[centerbox, left = 2.25cm of center] (free) {\includegraphics[height=1.25cm]{res/gnu-head.pdf}};
		}
		\visible<3->{
		...
		\visible<5->{
			\node[centerbox, right = 2.25cm of center] (open) {\includegraphics[height=1.25cm]{res/opensource.pdf}};
		}
		\visible<6->{
