...
\begin{frame}{Lizenz-Kategorien}
	\begin{center}
		\begin{tabular}{ccc}
		\visible<2->{\includegraphics[width=2.5cm]{res/PD-icon.pdf}} & \visible<3->{\includegraphics[width=2.5cm]{res/by.pdf}} & \visible<4->{\includegraphics[width=2.5cm]{res/copyleft.pdf}} \\ 
